    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
          ...
          <button id="btnSend" onclick="restSend()" class="btn btn-primary" >重新发送验证码</button>
	...
	<script>
        ...
        function completeApply(){
        	$.ajax({
                ...
                beforeSend : function(){
                	var email = $("#authcode").val().trim();
                	if(email==''){
                		layer.msg("验证码不能为空", {time:1500, icon:5, shift:6});
                		return false;
                	}
                },
