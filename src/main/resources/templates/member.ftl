			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  <a class="navbar-brand" href="member.htm" style="font-size:32px;">尚筹网-创意产品众筹平台</a>
				</div>
	...
	<div class="row clearfix">
		<div class="col-sm-3 col-md-3 column">
			...
			<div class="list-group">
				...
				<div class="list-group-item " style="cursor:pointer;" onclick="window.location.href='${APP_PATH}/minecrowdfunding'">
